...
//   console.log("select123", selectedPermission)
//   setIsPermissionModalOpen(true);        // Open the modal
//   setIsEditingPermission(true);  // Initially, it's not editing
...
const [isExitModalOpen, setIsExitModalOpen] = useState(false); // Modal state
  ...
  const openDescriptionModal = async (roleuser: RoleUser) => {
    // // console.log('Selected person:', person); 
    // setSelectedRole(roleuser);  // Set the selected person in the state
    // // console.log("select12345", selectedRole)
    ...
    } else if (responsepermission.includes("GET_ROLES")) {
 	setSelectedRole(roleuser);  // Set the selected person in the state
    // console.log("select12345", selectedRole)
...
const openPermissionModal = async (rolepermission: RoleUser) => {
  // // console.log('Selected person:', person); 
  // setSelectedPermission(rolepermission);  // Set the selected person in the state
  // // console.log("select123", selectedPermission)
  // setIsPermissionModalOpen(true);        // Open the modal
  ...
  } else if (responsepermission.includes("GET_PERMISSIONS")) {
  // console.log('Selected person:', person); 
setSelectedPermission(rolepermission);  // Set the selected person in the state
// console.log("select123", selectedPermission)
setIsPermissionModalOpen(true);        // Open the modal
