...
// //   // console.log('Selected person:', person); 
// //   console.log("Role Permission clicked:", rolepermission);

// //   setSelectedPermission(rolepermission);  // Set the selected person in the state
// //   console.log("qazxcvdswe", selectedPermission);
// // if (selectedPermission){
// //    setPermissionsList(selectedPermission.RolePermission); // Set the pre-checked permissions for this role
// //    console.log("qazxcvdswe11", permissionslist);

// //   setIsPermissionModalOpen(true);        // Open the modal
// //   console.log("qazxcvdswe11", isPermissionModalOpen);
...
// //   setSelectedPermission(null);     // Reset the selected person
// // };
...
// //   try {
// //     // Update the user on the backend
// //     const updatedPermission = await editPermission(PermissionEdit.id, permissionslist);
// //     // console.log("The new data:", updatedUser);

// //     // Update the local data state with the new user information
// //     const updatedData = data.map(rolepermission =>
// //       rolepermission.id === updatedPermission.id ? { ...rolepermission, ...updatedPermission } : rolepermission
// //     );
    
// //     setData(updatedData); // Update the data state
// //     // console.log(updatedData);

// //     setPermissionEdit(null); // Clear the edit state
// //     setIsEditPermissionModalOpen(false); // Close the Edit Modal

// //     // Reopen the Detail Modal with the updated data
// //     setTimeout(() => {
// //       setIsPermissionModalOpen(true); // Reopen the detail modal
// //       setSelectedPermission(updatedPermission); // Set the updated user to detail modal
// //     }, 100); // A short delay to ensure the modal closes and reopens with updated state
...
//   onSave={handleSavePermissionConfirm} // Save the changes
// />
