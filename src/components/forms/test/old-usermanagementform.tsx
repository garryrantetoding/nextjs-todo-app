...
//     name: '',
//     email: '',
//     roles: Role.Empty, // Default role should be one of the enum values like Role.Staff
//     password: ''
//   });
...
//   // Function to discard changes and close the UserModal
//   const discardChanges = () => {
//     setNewUser({ name: '', email: '', roles: Role.Empty, password: '' });  // Reset roles to a default value
//     closeModal();
//     closeDiscardConfirmationModal();
//   };

//   const handleAddUser = async (name: string, email: string, role: string, password: string) => {
...
//       name,
//       email,
//       roles: roleEnumValue,  // Use the Role enum value
